...
export default async function PublicInvoicePage({ params }: PageParams) {
  ...
  const typedLineItems =
    (lineItems as { id: string; invoice_id: string; description: string; quantity: number | null; unit_price_cents: number | null; amount_cents: number }[])
      ...
      <div className="content-max">
        <div className="flex items-start justify-between mb-8">
          ...
          <div className="flex flex-col items-end gap-2">
            ...
            <a
              href={`/api/public/invoices/${token}/checkout`}
